...
{
    [Tooltip("Items that's in this ObjectPool")]
    public GameObject PooledObject;
    [Tooltip("Amount of items this ObjectPool starts out with")]
    public int PoolSize;
    ...
    private void Expand(int expansionSize)
    {
        ...
        {
            UnityEngine.GameObject newObject = Instantiate(PooledObject);
    ...
    public UnityEngine.GameObject GetPooledObject(Vector3 position, Quaternion rotation, Transform parent = null)
    {
